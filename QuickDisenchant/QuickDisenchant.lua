...
local DISENCHANT_RESOLVE_TIMEOUT_SECONDS = 3.0
...
local function ensureMainWindow()
  ...
  local frame, titleText, scrollFrame, contentFrame, emptyText = createWindowFrame("QuickDisenchantWindow")
...
local function ensureCandidateWindow()
  ...
  local frame, titleText, scrollFrame, contentFrame, emptyText = createWindowFrame("QuickDisenchantCandidateWindow")
